...
**Find urgent replies, overdue invoices, quotes, and customer follow-ups before they slip.**
...
First use: the assistant runs a guided 4-step setup (email, delivery channel, optional spreadsheet, first scan), then scans your recent email and shows you what it found.
